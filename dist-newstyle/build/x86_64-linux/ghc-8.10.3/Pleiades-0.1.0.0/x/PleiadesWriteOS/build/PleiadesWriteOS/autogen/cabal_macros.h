...
/* package Pleiades-0.1.0.0 */
#ifndef VERSION_Pleiades
#define VERSION_Pleiades "0.1.0.0"
#endif /* VERSION_Pleiades */
#ifndef MIN_VERSION_Pleiades
#define MIN_VERSION_Pleiades(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Pleiades */
...
#define CURRENT_COMPONENT_ID "Pleiades-0.1.0.0-inplace-PleiadesWriteOS"
